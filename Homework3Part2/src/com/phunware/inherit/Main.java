...
public class Main extends Object {
    ...
    public static void main(String [] args) {
        ...
        Class<?> chihuahuaClass = checkForClass("com.phunware.inherit.Chihuahua");
        Class<?> greatDaneClass = checkForClass("com.phunware.inherit.GreatDane");
        Class<?> goldenRetrieverClass = checkForClass("com.phunware.inherit.GoldenRetriever");
